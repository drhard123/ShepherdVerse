    ...
    try {
      ...
      if (canShare) {
        await Sharing.shareAsync(uri, {
          mimeType: 'image/png',
          dialogTitle: 'Save your verse card',
        });
      } else {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.banner}>
        <Text style={styles.bannerTitle}>Verse Card Creator</Text>
        <Text style={styles.bannerSub}>Create beautiful cards to share God's word</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        {/* This view gets captured as image */}
        <View
          ref={cardRef}
        ...
        <TouchableOpacity style={styles.loadBtn} onPress={loadVerse} disabled={loading}>
          {loading ? (
            ...
            <>
              ...
              <Text style={styles.loadBtnText}>Load New Verse</Text>
            </>
          )}
        </TouchableOpacity>
      </View>
